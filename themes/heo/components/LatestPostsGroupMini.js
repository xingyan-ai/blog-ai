      ...
      {latestPosts.map(post => {
        ...
        return (
          <Link
            ...
            passHref
            className={'my-3 flex'}>
            <div className='w-20 h-14 aspect-[7/4] overflow-hidden relative'>
              <LazyImage
                src={`${headerImage}`}
            ...
            <div
              className={
                ...
                ' text-xs font-medium overflow-x-hidden hover:text-indigo-600 px-2 duration-200 w-full rounded ' +
