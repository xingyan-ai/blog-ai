...
export default function ReadingProgress() {
  ...
  return (<div
        ...
        className={`${scrollPercentage > 0 ? 'w-8 h-8 ' : 'w-0 h-0 opacity-0'} group cursor-pointer hover:bg-indigo-600 dark:hover:bg-yellow-600 hover:text-white rounded-full flex justify-center items-center duration-200 transition-all`}
    >
